...
class Abmc(): 
    ...
    def alta(self, nombre,apellido,sexo,email,username,password,tree, nombre_entry,apellido_entry,sexo_entry,email_entry,username_entry,password_entry  ):
        ...
        if (nombre and apellido and sexo and email and username and password  !=('')) :
            ...
            if (re.match(patron, cadena)):
                ...
                usuario.username    = username_entry.get()
                usuario.nombre      = nombre_entry.get()
                usuario.apellido    = apellido_entry.get()
                usuario.password    = password_entry.get()
                ...
                self.actualizar_treeview(tree)
                    ...
                    showerror("error al guardar", "Username debe ser alfabetico")
    ...
    def borrar(self,tree):
        ...
        borrar = Usuarios.get(Usuarios.usuario_id==item['text'] )
