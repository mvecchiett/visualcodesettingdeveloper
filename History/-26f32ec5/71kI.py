...
class Abmc(): 
    ...
    def crear_tabla(self,):
        ...
        sql = """CREATE TABLE IF NOT EXISTS `usuarios` 
                ...
                nombre TEXT, apellido TEXT, sexo TEXT, email TEXT, username TEXT, password TEXT)")
                """
        cursor.execute(sql)
        con.commit()


    def alta(self,nombre,apellido,sexo,email, username ,  password):
        ...
        if (nombre and apellido and sexo and email and username and password  !=('')) :
            ...
            if (re.match(patron, cadena)):
                ...
                self.borrar_entry(username ,  password)
    ...
    def borrar_entry(self,username, password): 
