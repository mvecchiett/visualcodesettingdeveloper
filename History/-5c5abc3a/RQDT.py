...
btn_alta = Button(Botones, width=10, text="Alta", command=funciones.Alta)
btn_alta.pack(side=LEFT)
btn_consulta = Button(Botones, width=10, text="Consulta", command=funciones.Consultar )
btn_consulta.pack(side=LEFT)
btn_guardar = Button(Botones, width=10, text="Guardar", command=funciones.Guardar, state=DISABLED)
btn_guardar.pack(side=LEFT)
btn_borrar = Button(Botones, width=10, text="Borrar", command=funciones.Borrar)
btn_borrar.pack(side=LEFT)
btn_salir = Button(Botones, width=10, text="Exit", command=funciones.Salir)
