...
class Ventanita:
    def __init__(self, window):
        ...
        self.Ent2 = Entry(self.root, textvariable=self.vsexo)
        self.Ent2.grid(row=3, column=1)
        self.Ent2 = Entry(self.root, textvariable=self.vemail)
        self.Ent2.grid(row=4, column=1)
        self.Ent2 = Entry(self.root, textvariable=self.vusername)
        self.Ent2.grid(row=5, column=1)                        
        self.Ent2 = Entry(self.root, textvariable=self.vpassword)
    ...
    def alta(
        ...
        self.objeto_base.alta(self.vnombre, self.vapellido, self.vsexo, self.vemail, self.vusername, self.vpassword, self.tree)
    ...
    def modificar(
        ...
        self.objeto_base.modificar(self.vnombre, self.vapellido, self.vsexo, self.vemail, self.vusername, self.vpassword, self.tree)
