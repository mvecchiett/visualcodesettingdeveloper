...
class panel ():
    def __init__(self,window):
        ...
        self.sexo_entry = Entry(self.master,textvariable=self.var_sexo, width=25)
        ...
        self.username_entry = Entry(self.master,textvariable=self.var_username, width=25)
        self.username_entry.grid(row=7, column=1, padx=50)

        self.password_entry = Entry(self.master,textvariable=self.var_password, width=25)
...
# --------------------------------------------------
        ...
        self.var_nombre.get(), self.var_apellido.get(), self.var_sexo.get(), self.var_email.get(), self.var_username.get(),self.var_password.get(),
        self.tree,self.nombre_entry, self.apellido_entry, self.sexo_entry, self.email_entry, self.username_entry, self.password_entry))
